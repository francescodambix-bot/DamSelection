...
function SearchPage({ query, setQuery, minProfitFilter, setMinProfitFilter, onSelectItem }) {
  ...
  async function handleLiveSearch() {
    ...
    try {
      ...
      setLiveSearchError(`Errore nella ricerca dal vivo: ${e.message || e}. (Se il messaggio parla di rete/fetch fallito, vuol dire che la richiesta non è nemmeno partita; se parla di uno status HTTP tipo 403/429, è Vinted che ha rifiutato la richiesta.)`);
    } finally {
